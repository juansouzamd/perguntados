...
public class BancoDados {
    ...
    // Obtém a conexão com o banco de dados. Se a conexão ainda não foi estabelecida, cria uma nova conexão e a retorna. Caso contrário, retorna a conexão existente.
    ...
    // Fecha a conexão com o banco de dados, caso esteja aberta. Caso contrário, nenhum procedimento é realizado.
    ...
    // Carrega as propriedades do arquivo "banco.properties" e retorna um objeto properties. As propriedades são carregadas a partir de um arquivo de configuração externo. Em caso de falha ao carregar as propriedades, é lançada uma exceção personalizada.
    ...
    // Fecha um objeto Statement, liberando os recursos associados. Verifica se o objeto é diferente de nulo antes de fechá-lo. Em caso de falha ao fechar o objeto, é lançada uma exceção personalizada.
    ...
    // Fecha um objeto ResultSet, liberando os recursos associados. Verifica se o o bjeto é diferente de nulo antes de fechá-lo. Em caso de falha ao fechar o objeto, é lançada uma exceção personalizada.
